class CL_EX_BADI_01_MX definition
  public
  final
  create public .
...
CLASS CL_EX_BADI_01_MX IMPLEMENTATION.
  ...
  DATA: exitintf TYPE REF TO IF_EX_BADI_01_MX,
  ...
  IF <flt_cache_line>-valid = sxrt_true.
    ...
    CALL FUNCTION 'PF_ASTAT_OPEN'
       EXPORTING
           OPENKEY = '051MXWHr7jI1q3FD4OYHX0'
           TYP     = 'UE'.
        ...
        IF <flt_cache_line>-eo_object is initial.
          CALL METHOD ('CL_FOBU_METHOD_EVALUATION')=>load
               EXPORTING
                  ...
                  im_interface_name = 'IF_EX_BADI_01_MX'
