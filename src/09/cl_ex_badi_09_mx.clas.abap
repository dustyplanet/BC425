class CL_EX_BADI_09_MX definition
  public
  final
  create public .
...
CLASS CL_EX_BADI_09_MX IMPLEMENTATION.


  method IF_EX_BADI_09_MX~EXIT_MENU_BOOK.
  CLASS CL_EXIT_MASTER DEFINITION LOAD.
  DATA: EXIT_OBJ_TAB TYPE SXRT_EXIT_TAB.

  DATA: exitintf TYPE REF TO IF_EX_BADI_09_MX,
  ...
  IF <flt_cache_line>-valid = sxrt_true.
    ...
    CALL FUNCTION 'PF_ASTAT_OPEN'
       EXPORTING
           OPENKEY = '051MXWHr7jI1vojFVaCnX0'
           TYP     = 'UE'.
        ...
        IF <flt_cache_line>-eo_object is initial.
          CALL METHOD ('CL_FOBU_METHOD_EVALUATION')=>load
               EXPORTING
                  ...
                  im_interface_name = 'IF_EX_BADI_09_MX'
